...
<head>
  <title>主页</title>
	...
	<link rel="stylesheet" type="text/css" href="css/sch-detail.css">
	</head>
<body>
	...
	<div class="content">
		<div id="schhead">
			<img id="schicon" src= ${temp_school.icon } />
			<div id="schname">${temp_school.name}</div>
		</div>
		<div id="schdesc">${temp_school.descs}</div>
	</div>
